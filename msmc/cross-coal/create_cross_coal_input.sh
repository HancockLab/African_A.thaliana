...
do
    ...
    do
       submit2sge -q cluster -N msmcgen${SAMPLE} "/usr/bin/python ~/msmc2-final/scripts/preprocessing/msmc_gen.py ${chrom} 4 ~/msmc2-xcoal/data/merged_vcfs/${p}.vcf.gz ~/msmc2-final/data/masks/${a1}.txt.gz ~/msmc2-final/data/masks/${a2}.txt.gz ~/msmc2-final/data/masks/${b1}.txt.gz ~/msmc2-final/data/masks/${b2}.txt.gz"
    done
