...
public class Pairwise_shore {
	...
	public void setMatrixFile(String matrixName, String accessionString){
...
//				}
			...
			Writer writer = new FileWriter("/global/lv70590/Andrea/pi_july/pi" + accessionIndex + ".txt");
			...
			out.close();
                        ...
                        Writer writer2 = new FileWriter("/global/lv70590/Andrea/pi_july/len" + accessionIndex + ".txt");
                        ...
                        Writer writer3 = new FileWriter("/global/lv70590/Andrea/pi_july/dif" + accessionIndex + ".txt");
			...
			Writer writerN = new FileWriter("/global/lv70590/Andrea/pi_july/names.txt");
...
*/
	...
	public static void main(String[] args) {
		...
		pairwise_shore.setMatrixFile(args[0], args[1]);
	}
}
