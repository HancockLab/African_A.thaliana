	...
	private Mor_private_haps_admClusters() {}
        ...
        public void runTheMatrix(String matrixName, String groupStr, String sampleStr) {
			...
			while (scanner1001.hasNextLine()) {
				...
				if (!isArel && !splitSnp[12].equals("forbidden")) {
                                	the1001 = the1001 + 1;
                        	} else {
				...
				Boolean isArel = false;
                                ...
                                if (!isArel && !splitSnp[12].equals("forbidden")) {
                                	...
                                	thousAdmixtures[the1001] = "Eurasia";						// splitSnp[12];
                                	the1001 = the1001 + 1;
                        	}
			}
		...
		if (morTogether) {
                        ...
                        writer = new FileWriter("/global/lv70590/Andrea/privateHaps_morVsEurasia/" + group + "/" + sample + ".txt");
                } else {
                	// writer = new FileWriter("/global/lv70590/Andrea/privateHaps_admClusters/" + group + "/" + sample + ".txt");
		}
